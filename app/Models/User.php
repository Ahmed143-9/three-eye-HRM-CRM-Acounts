...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function userDefaultDataRegister($user_id)
    {
        ...
        self::userDefaultLeaveTypes($user_id);
    }

    public static function userDefaultLeaveTypes($user_id)
    {
        LeaveType::insert([
            ['title' => 'Casual Leave',  'days' => 14, 'is_attachment_required' => 0, 'min_advance_days' => 0,  'is_default' => 1, 'created_by' => $user_id, 'created_at' => now(), 'updated_at' => now()],
            ['title' => 'Sick Leave',    'days' => 7,  'is_attachment_required' => 1, 'min_advance_days' => 0,  'is_default' => 1, 'created_by' => $user_id, 'created_at' => now(), 'updated_at' => now()],
            ['title' => 'Paid Leave',    'days' => 14, 'is_attachment_required' => 0, 'min_advance_days' => 0,  'is_default' => 1, 'created_by' => $user_id, 'created_at' => now(), 'updated_at' => now()],
            ['title' => 'Annual Leave',  'days' => 15, 'is_attachment_required' => 0, 'min_advance_days' => 10, 'is_default' => 1, 'created_by' => $user_id, 'created_at' => now(), 'updated_at' => now()],
        ]);
    }
