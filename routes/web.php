...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('invoice/create/{cid}', [InvoiceController::class, 'create'])->name('invoice.create.cid');
    ...
    Route::get('loan/{loan}/attachment', [LoanController::class, 'downloadAttachment'])->name('loan.attachment.download')->middleware(['auth', 'XSS']);
    ...
    Route::get('payslip/unpaysalary/{id}/{date}', [PaySlipController::class, 'unpaysalary'])->name('payslip.unpaysalary')->middleware(['auth', 'XSS']);
    ...
    Route::get('leave/attachment/{id}/download', [LeaveController::class, 'downloadAttachment'])->name('leave.attachment.download')->middleware(['auth', 'XSS']);
    Route::delete('leave/attachment/{id}', [LeaveController::class, 'deleteAttachment'])->name('leave.attachment.delete')->middleware(['auth', 'XSS']);
