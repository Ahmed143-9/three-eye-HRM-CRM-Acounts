...
@section('page-title', __('Manage Suppliers'))
@section('breadcrumb')
...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('suppliers.create') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{ __('Create') }}">
                                ...
                                <tr>
                                    ...
                                    <td class="Action">
                                        <div class="action-btn bg-info ms-2">
                                            <a href="{{ route('suppliers.edit', $item->id) }}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" title="{{ __('Edit') }}">
