                ...
                <form method="POST" action="{{ route('consultants.update', $consultant->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="bank_name" value="{{ $consultant->bank_name }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="form-label">{{ __('Bank Branch') }}</label>
                            <input type="text" class="form-control" name="bank_branch" value="{{ $consultant->bank_branch }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="form-label">{{ __('Account Number') }}</label>
                            <input type="text" class="form-control" name="bank_account_number" value="{{ $consultant->bank_account_number }}">
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div id="file_attachment_container">
                                @php
                                    ...
                                    if(!is_array($files)) $files = $consultant->file_attachment ? [$consultant->file_attachment] : [];
                                @endphp
