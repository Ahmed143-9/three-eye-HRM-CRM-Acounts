...
<div class="modal-body">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <h5 class="mb-3">{{__('Edit Permissions')}}</h5>
                </div>
                                    ...
                                    @foreach($groupPermissions as $permissionName)
                                        ...
                                        @if($id)
                                            <div class="col-12 mb-2">
                                                <div class="form-check">
                                                    {{Form::checkbox('permissions[]', $id, in_array($permissionName, $role->permissions->pluck('name')->toArray()), ['class'=>'form-check-input permission-item group-' . Str::slug($groupName), 'id' =>'permission_'.$id])}}
...
<script>
    $(document).ready(function () {
        ...
        $('.permission-item').click(function(){
            ...
            var groupName = groupClass.replace('group-', '');
            var allChecked = $('.group-' + groupName).length === $('.group-' + groupName + ':checked').length;
