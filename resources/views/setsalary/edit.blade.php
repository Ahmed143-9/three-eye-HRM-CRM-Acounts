                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(!empty($loan->attachment))
                                                        @php $ext = strtolower(pathinfo($loan->attachment, PATHINFO_EXTENSION)); @endphp
                                                        @if(in_array($ext, ['jpg','jpeg','png']))
                                                            <a href="{{ route('loan.attachment.download', $loan->id) }}" target="_blank" class="btn btn-xs btn-outline-info me-1" title="{{ __('View') }}"><i class="ti ti-eye"></i></a>
                                                        @endif
                                                        <a href="{{ route('loan.attachment.download', $loan->id) }}" class="btn btn-xs btn-outline-secondary" title="{{ __('Download') }}"><i class="ti ti-download"></i></a>
                                                    @else
