{{Form::open(array('url'=>'leave','method'=>'post', 'class'=>'needs-validation', 'novalidate', 'files'=>true))}}
...
<script>
    // Build a map of leave type rules from PHP
    var leaveTypeRules = {
    ...
    function updateAttachmentUI(leaveTypeId) {
        ...
        if (rules && rules.is_attachment_required) {
