                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($item->attachments_count > 0)
                                            <span class="badge bg-info" title="{{ __('Has attachments') }}">
                                                <i class="ti ti-paperclip"></i> {{ $item->attachments_count }}
                                            </span>
                                        @else
                                    ...
                                    <td>
                                        ...
                                        <div class="action-btn me-2">
                                            <a href="#" data-url="{{ route('leave.show', $item->id) }}" data-size="lg" data-ajax-popup="true"
                                               data-title="{{__('Leave Details')}}"
