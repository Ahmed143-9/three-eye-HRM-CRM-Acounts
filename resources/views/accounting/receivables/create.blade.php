...
@section('page-title', __('Create Receivable'))
@section('breadcrumb')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4" id="entity_div" style="display:none;">
                            <label class="form-label" id="entity_label">{{ __('Entity') }}</label>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="items_table">
                            ...
                            <tbody>
                                <tr data-id="1">
                                    <td><input type="text" class="form-control" name="items[0][serial]" value="1"></td>
                                    <td><textarea class="form-control" name="items[0][order_details]" rows="1"></textarea></td>
                                    <td><input type="number" class="form-control qty" name="items[0][qty]" value="0" step="0.01"></td>
                                    <td><input type="number" class="form-control rate" name="items[0][rate]" value="0" step="0.01"></td>
                                    <td><input type="number" class="form-control amount" name="items[0][amount]" value="0" step="0.01" readonly></td>
                                    <td></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control" name="total_amount" id="total_amount" value="0" step="0.01" readonly></td>
            ...
            if (direction) {
                ...
                if (dataArray.length > 0) {
                    $.each(dataArray, function(i, item) {
                        entitySelect.append('<option value="' + item.id + '" data-address="' + (item.billing_address || '') + '">' + item.name + '</option>');
                    });
                } else {
